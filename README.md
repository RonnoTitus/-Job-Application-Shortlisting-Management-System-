...
### 👩‍💼 For Applicants
- Browse and apply for **available job positions** online.
- Track the **status of submitted applications** (Under Review, Shortlisted, Rejected).
- Receive updates in a clean, easy-to-navigate **user dashboard**.
- View job details including qualifications, responsibilities, and deadlines.
...
| Data Persistence | LocalStorage / Mock Backend (Configurable) |
